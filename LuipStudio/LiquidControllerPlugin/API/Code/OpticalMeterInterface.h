 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OMI_START_STATIC_AD_CONTROL                  (DSCP_OMI_CBASE + 0x10)
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OMI_STOP_STATIC_AD_CONTROL                    (DSCP_OMI_CBASE + 0x11)
 ...
 */
#define DSCP_CMD_OMI_GET_STATIC_AD_CONTROL_PARAM              (DSCP_OMI_CBASE + 0x12)
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OMI_SET_STATIC_AD_CONTROL_PARAM              (DSCP_OMI_CBASE + 0x13)
 ...
 */
#define DSCP_CMD_OMI_IS_STATIC_AD_CONTROL_VALID              (DSCP_OMI_CBASE + 0x14)
// *******************************************************************
// 事件
