 ...
 * @brief 设置基线状态。
 */
void StatusManager::SetBaseline(BaseLineStatus status)
{
    QWriteLocker locker(&m_baselineLock);
 ...
 * @brief 设置温度。
 */
void StatusManager::SetTemperature(float temp)
{
    QWriteLocker locker(&m_temperatureLock);
