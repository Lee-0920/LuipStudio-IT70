...
enum MeterMode
{
    ...
    METER_MODE_ROPINESS = 3             ///< 粘稠定量模式，过程与精准一样，增加判定平台时间长度
};
 ...
 */
#define DSCP_CMD_OMI_GET_LED_LEVEL          (DSCP_OMI_CBASE + 0x10)
 ...
 * @param level Uint8，设置光强等级。范围：0-1。
  ...
  *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OMI_SET_LED_LEVEL          (DSCP_OMI_CBASE + 0x11)
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OMI_START_STATIC_AD_CONTROL                  (DSCP_OMI_CBASE + 0x12)
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OMI_STOP_STATIC_AD_CONTROL                    (DSCP_OMI_CBASE + 0x13)

/**
 * @brief 查询默认静态AD控制参数。
 * @return value Uint16 ，静态AD调节参数。
 * @see DSCP_CMD_OMI_SET_STATIC_AD_CONTROL_PARAM
 */
#define DSCP_CMD_OMI_GET_STATIC_AD_CONTROL_PARAM              (DSCP_OMI_CBASE + 0x14)
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OMI_SET_STATIC_AD_CONTROL_PARAM              (DSCP_OMI_CBASE + 0x15)
 ...
 */
#define DSCP_CMD_OMI_IS_STATIC_AD_CONTROL_VALID              (DSCP_OMI_CBASE + 0x16)
 ...
 * @see DSCP_CMD_OMI_START_STATIC_AD_CONTROL
 */
#define DSCP_EVENT_OMI_STATIC_AD_CONTROL_RESULT                  (DSCP_OMI_EBASE + 0x03)
