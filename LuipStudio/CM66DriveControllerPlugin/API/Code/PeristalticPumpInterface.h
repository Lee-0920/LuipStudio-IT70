 ...
 */
#define DSCP_CMD_PPI_GET_PUMP_FIXED_TYPE                (DSCP_PPI_CBASE + 0x09)
 ...
 *  - @ref DSCP_ERROR_PARAM 参数错误，传入的参数有问题
 */
#define DSCP_CMD_PPI_SET_PUMP_FIXED_TYPE                  (DSCP_PPI_CBASE + 0x0A)
 ...
 */
#define DSCP_CMD_PPI_GET_SENSE_STATUS                  (DSCP_PPI_CBASE + 0x0B)
