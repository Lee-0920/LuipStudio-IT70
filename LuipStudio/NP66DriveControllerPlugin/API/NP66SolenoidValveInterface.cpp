 ...
 * @param[in] addr 设备地址。
 */
NP66SolenoidValveInterface::NP66SolenoidValveInterface(DscpAddress addr)
 ...
 */
int NP66SolenoidValveInterface::GetTotalValves()
{
    int totalValves = 0;
 ...
 */
NP66ValveMap NP66SolenoidValveInterface::GetValveMap()
{
    NP66ValveMap map(0);
...
* @return 返回状态，操作是否成功。
 */
bool NP66SolenoidValveInterface::SetValveMap(NP66ValveMap map)
{
