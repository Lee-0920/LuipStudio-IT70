 ...
 * @param[in] addr 设备地址。
 */
NP66TemperatureControlInterface::NP66TemperatureControlInterface(DscpAddress addr)
...
NP66TempCalibrateFactor NP66TemperatureControlInterface::GetCalibrateFactor() const
{
    NP66TempCalibrateFactor factor = {0, 0, 0};
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66TemperatureControlInterface::SetCalibrateFactor(NP66TempCalibrateFactor factor)
{
 ...
 */
NP66Temperature NP66TemperatureControlInterface::GetTemperature() const
{
    NP66Temperature temp;
    ...
    if (resp)
    {
        temp = *((NP66Temperature*)resp->data);
    }
 ...
 */
NP66ThermostatParam NP66TemperatureControlInterface::GetThermostatParam() const
{
    NP66ThermostatParam param;
    ...
    if (resp)
    {
        param = *((NP66ThermostatParam*)resp->data);
    }
...
* @return 返回状态，操作是否成功。
 */
bool NP66TemperatureControlInterface::SetThermostatParam(NP66ThermostatParam param)
{
    Uint16 status = DscpStatus::Error;
...
Uint16 NP66TemperatureControlInterface::GetThermostatStatus() const
{
 ...
 * @param[in] mode Uint8，恒温模式，支持的模式见： @ref NP66ThermostatMode 。
 ...
 */
bool NP66TemperatureControlInterface::StartThermostat(NP66ThermostatMode mode, float targetTemp, float toleranceTemp, float timeout)
{
    Uint16 status = DscpStatus::Error;
    Uint8 cmdData[13] = {0};
 ...
 * @note 该命令将立即返回。
 */
bool NP66TemperatureControlInterface::StopThermostat()
{
    Uint16 status = DscpStatus::Error;
 ...
 */
bool NP66TemperatureControlInterface::SetTemperatureNotifyPeriod(float period)
{
    Uint16 status = DscpStatus::Error;
 ...
 *  - @ref result Uint8，恒温结果码（ @ref NP66ThermostatResult ）。
 *  - @ref temp float，当前温度。
 */
NP66ThermostatResult NP66TemperatureControlInterface::ExpectThermostat(long timeout)
{
    NP66ThermostatResult thermostatResult;
 ...
 */
void NP66TemperatureControlInterface::RegisterTemperatureNotice(IEventReceivable *handle)
{
 ...
 */
bool NP66TemperatureControlInterface::BoxFanSetOutput(float level)
{
    Uint16 status = DscpStatus::Error;
 ...
 * @param level float ,风扇速率，对应高电平占空比。默认为0，风扇关闭。
 */
bool NP66TemperatureControlInterface::DigestionFanSetOutput(float level)
{
    Uint16 status = DscpStatus::Error;
 ...
 * @note
 */
float NP66TemperatureControlInterface::GetHeaterMaxDutyCycle() const
{
 ...
 */
bool NP66TemperatureControlInterface::SetHeaterMaxDutyCycle(float maxDutyCycle)
{
    Uint16 status = DscpStatus::Error;
 ...
 */
NP66ThermostatParam NP66TemperatureControlInterface::GetCurrentThermostatParam() const
{
    NP66ThermostatParam param;
    memset(&param, 0, sizeof(param));
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66TemperatureControlInterface::SetCurrentThermostatParam(NP66ThermostatParam param)
{
    Uint16 status = DscpStatus::Error;
