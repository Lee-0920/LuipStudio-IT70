 ...
 * @param[in] addr 设备地址。
 */
NP66OpticalAcquireInterface::NP66OpticalAcquireInterface(DscpAddress addr)
 ...
 * @return 返回状态，操作是否成功。
 */
bool NP66OpticalAcquireInterface:: TurnOnLED() const
{
 ...
 */
bool NP66OpticalAcquireInterface::SetAcquireADNotifyPeriod(float period)
{
    Uint16 status = DscpStatus::Error;
 ...
 * @return 返回状态，操作是否成功。
 */
bool NP66OpticalAcquireInterface:: StartAcquirer(float acquireTime)
{
    Uint16 status = DscpStatus::Error;
 ...
 * @return 返回状态，操作是否成功。
 */
bool NP66OpticalAcquireInterface:: StopAcquirer()
{
    Uint16 status = DscpStatus::Error;
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66OpticalAcquireInterface::StartLEDController()
{
    Uint16 status = DscpStatus::Error;
 ...
 * @return 返回状态，操作是否成功。
 */
bool NP66OpticalAcquireInterface:: TurnOffLED() const
{
    Uint16 status = DscpStatus::Error;
 ...
 */
Uint32 NP66OpticalAcquireInterface::GetLEDControllerTartet() const
{
    Uint32 target = 0;
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66OpticalAcquireInterface::SetLEDControllerTarget(Uint32 target)
{
    Uint16 status = DscpStatus::Error;
 ...
 */
NP66LedParam NP66OpticalAcquireInterface::GetLEDControllerParam() const
{
    NP66LedParam param;
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66OpticalAcquireInterface::SetLEDControllerParam(NP66LedParam param)
{
    Uint16 status = DscpStatus::Error;
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66OpticalAcquireInterface::SetLEDControllerStableTarget(Uint32 targetAD, Uint32 tolerance, Uint32 timeout)
{
    Uint16 status = DscpStatus::Error;
    Uint8 cmdData[12] = {0};
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66OpticalAcquireInterface::StartStaticADControl(Uint8 index, Uint32 targetAD)
{
    Uint16 status = DscpStatus::Error;
    Uint8 cmdData[5] = {0};
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66OpticalAcquireInterface::StopStaticADControl()
{
    Uint16 status = DscpStatus::Error;
 ...
 */
Uint16 NP66OpticalAcquireInterface::GetStaticADControlParam(Uint8 index) const
{
    Uint16 value = 0;
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66OpticalAcquireInterface::SetStaticADControlParam(Uint8 index, Uint16 value)
{
    Uint16 status = DscpStatus::Error;
    Uint8 cmdData[3] = {0};
    memcpy(cmdData, &index, sizeof(Uint8));
 ...
 */
bool NP66OpticalAcquireInterface::IsStaticADControlValid() const
{
    Uint16 status = DscpStatus::Error;
 ...
 */
NP66OpticalAD NP66OpticalAcquireInterface:: ExpectADAcquirer(long timeout)
{
    NP66OpticalAD AD;
 ...
 */
void NP66OpticalAcquireInterface::RegisterAcquireADNotice(IEventReceivable *handle)
{
 ...
 */
NP66AdjustResult NP66OpticalAcquireInterface::ExpectADStableAdjust(long timeout)
{
    NP66AdjustResult adjustResult;
    memset(&adjustResult, 0, sizeof(adjustResult));
    DscpEventPtr event = this->Expect(DSCP_EVENT_OAI_AD_ADJUST_RESULT,timeout);

    if (event != nullptr)
    {
        adjustResult = (NP66AdjustResult)(*(event->data));
    }
 ...
 * @see DSCP_CMD_OAI_START_LEDADJUST
 */
NP66StaticADControlResult NP66OpticalAcquireInterface::ExpectStaticADControlResult(long timeout)
{
    NP66StaticADControlResult result = NP66StaticADControlResult::Unfinished;

    DscpEventPtr event = this->Expect(DSCP_EVENT_OAI_STATIC_AD_CONTROL_RESULT, timeout);

    if (event != nullptr)
    {
        result = (NP66StaticADControlResult)(*(event->data));
    }
