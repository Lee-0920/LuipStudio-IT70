 ...
 * @param[in] addr 设备地址。
 */
NP66OpticalMeterInterface::NP66OpticalMeterInterface(DscpAddress addr)
...
bool NP66OpticalMeterInterface::TurnOnLED(Uint8 num)
{
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66OpticalMeterInterface::TurnOffLED(Uint8 num)
{
    Uint16 status = DscpStatus::Error;
 ...
 */
//bool NP66OpticalMeterInterface::AutoCalibratePump(Uint32 valve)
//{
//    Uint16 status = DscpStatus::Error;
//
 ...
 */
float NP66OpticalMeterInterface::GetPumpFactor() const
{
    float factor =0 ;
 ...
 */
bool NP66OpticalMeterInterface::SetPumpFactor(float factor)
{
    Uint16 status = DscpStatus::Error;
 ...
 * @see DSCP_CMD_OMI_SET_METER_POINTS
 */
NP66MeterPoints NP66OpticalMeterInterface::GetMeterPoints() const
{
    NP66MeterPoint point;
    NP66MeterPoints points;
 ...
 */
bool NP66OpticalMeterInterface::SetMeterPoints(NP66MeterPoints points)
{
    Uint16 status = DscpStatus::Error;
    int count = points.GetNum() * sizeof(NP66MeterPoint);
 ...
 */
Uint16 NP66OpticalMeterInterface::GetMeterStatus() const
{
 ...
 * @param[in] mode Uint8，定量模式，支持的模式见： @ref NP66MeterMode 。
 ...
 */
bool NP66OpticalMeterInterface::StartMeter(NP66RollDirection dir, NP66MeterMode mode, float volume, float limitVolume)
{
    Uint16 status = DscpStatus::Error;
    Uint8 cmdData[10] = {0};
 ...
 * @note 该命令将立即返回。
 */
bool NP66OpticalMeterInterface::StopMeter()
{
    Uint16 status = DscpStatus::Error;
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66OpticalMeterInterface::IsAutoCloseValve(bool isCloseValve)
{
    Uint16 status = DscpStatus::Error;
 ...
 */
bool NP66OpticalMeterInterface::SetOpticalADNotifyPeriod(float period)
{
    Uint16 status = DscpStatus::Error;
 ...
 * @returen Uint8，定量结果码（ @ref NP66MeterResult ），定义如下：
 *  - @ref Finished 定量正常完成。
 ...
 */
NP66MeterResult NP66OpticalMeterInterface::ExpectMeterResult(int timeout)
{
    NP66MeterResult result = NP66MeterResult::Failed;

    DscpEventPtr event = this->Expect(DSCP_EVENT_OMI_METER_RESULT,timeout);

    if (event != nullptr)
    {
        result = (NP66MeterResult)(*event->data);
    }
 ...
 *  - @ref Unfinished 定量目标未达成。
 */
//NP66MeterResult NP66OpticalMeterInterface::ExpectAutoCalibrateResult(long timeout)
//{
//    NP66MeterResult result = NP66MeterResult::Failed;
//
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66OpticalMeterInterface::SetMeteSpeed(float speed)
{
    Uint16 status = DscpStatus::Error;
 ...
 */
float NP66OpticalMeterInterface::GetMeteSpeed() const
{
    float speed =0 ;
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
bool NP66OpticalMeterInterface::SetMeterFinishValveMap(Uint32 map)
{
    Uint16 status = DscpStatus::Error;
 ...
 */
Uint32 NP66OpticalMeterInterface::GetSingleOpticalAD(Uint8 num) const
{
    Uint32 adValue =0 ;
 ...
 */
void NP66OpticalMeterInterface::RegisterOpticalADNotice(IEventReceivable *handle)
{
