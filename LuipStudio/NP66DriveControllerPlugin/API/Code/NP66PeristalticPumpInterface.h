/**
 * @page page_NP66PeristalticPumpInterface 蠕动泵控制接口
 *  蠕动泵控制接口提供了控制蠕动泵运转的相关操作。
 *
 *  具体命令见： @ref module_NP66PeristalticPumpInterface
 *
...
/**
 * @addtogroup module_NP66PeristalticPumpInterface 蠕动泵控制接口
 * @{
 */
 ...
 * @param result Uint8，泵操作结果码（ @ref NP66PumpResult ），定义如下：
