/**
 * @page page_NP66OpticalMeterInterface 光学定量接口
 *  光学定量接口提供了控制蠕动泵运转的相关操作。
 *
 *  具体命令见： @ref module_NP66OpticalMeterInterface
 *
...
/**
 * @addtogroup module_NP66OpticalMeterInterface 光学定量接口
 * @{
 */
 ...
 * @param mode Uint8，定量模式，支持的模式见： @ref NP66MeterMode 。
 ...
 * @param result Uint8，定量结果码（ @ref NP66MeterResult ），定义如下：
