...
#include "../../../LuipStudio/Luip/FlowManager/FlowManager.h"
...
QT_MOC_LITERAL(1, 18, 15), // "StartFlowSignal"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 13) // "StartFlowSlot"

    },
    "Flow::FlowManager\0StartFlowSignal\0\0"
    "StartFlowSlot"
};
...
void Flow::FlowManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->StartFlowSignal(); break;
        case 1: _t->StartFlowSlot(); break;
        default: ;
        }
        ...
        {
            typedef void (FlowManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FlowManager::StartFlowSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Flow::FlowManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Flow__FlowManager.data,
...
// SIGNAL 0
void Flow::FlowManager::StartFlowSignal()
{
