...
#include "../../../LuipStudio/Luip/System/LockScreen/ScreenProtection.h"
...
QT_MOC_LITERAL(1, 33, 19), // "ScreenUpdateRequest"
QT_MOC_LITERAL(2, 53, 0) // ""

    },
    "System::Screen::Screenprotection\0"
    "ScreenUpdateRequest\0"
};
...
void System::Screen::Screenprotection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Screenprotection *_t = static_cast<Screenprotection *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ScreenUpdateRequest(); break;
        default: ;
        }
        ...
        {
            typedef void (Screenprotection::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Screenprotection::ScreenUpdateRequest)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void System::Screen::Screenprotection::ScreenUpdateRequest()
{
